                    ...
                    <div style={{ position: 'absolute', bottom: '30px', left: 0, right: 0, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <div>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', paddingBottom: '10px' }}>
                                ...
                                <Draggable>
                                    <div style={{ cursor: 'move' }}>
                                    <img src={icon_recycle} style={{pointerEvents: 'none',  width: '30px', objectFit: 'contain', paddingRight: '5px' }} />
                                    </div>
                                </Draggable>

                                <Draggable>
                                    <div style={{ cursor: 'move' }}>
                                    <img src={icon_world} style={{ pointerEvents: 'none', width: '30px', objectFit: 'contain', paddingRight: '5px' }} />
                                    </div>
                                </Draggable>
                                <Draggable>
                                    <div style={{ cursor: 'move' }}>
                                    <img src={icon_class} style={{pointerEvents: 'none',  width: '30px', objectFit: 'contain' }} />
                                    </div>
                                </Draggable>
